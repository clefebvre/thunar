                                      ...
                                      gpointer      marshal_data)
{
  typedef guint (*GMarshalFunc_FLAGS__OBJECT_OBJECT) (gpointer     data1,
                                                      ...
                                                      gpointer     arg_2,
                                                      gpointer     data2);
  GMarshalFunc_FLAGS__OBJECT_OBJECT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  guint v_return;
                                     ...
                                     gpointer      marshal_data)
{
  typedef guint (*GMarshalFunc_FLAGS__STRING_FLAGS) (gpointer     data1,
                                                     ...
                                                     guint        arg_2,
                                                     gpointer     data2);
  GMarshalFunc_FLAGS__STRING_FLAGS callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  guint v_return;
...
_thunar_marshal_VOID__UINT64_UINT_UINT_UINT (GClosure     *closure,
                                             ...
                                             gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT64_UINT_UINT_UINT) (gpointer     data1,
                                                            guint64      arg_1,
                                                            guint        arg_2,
                                                            guint        arg_3,
                                                            guint        arg_4,
                                                            gpointer     data2);
  GMarshalFunc_VOID__UINT64_UINT_UINT_UINT callback;
  GCClosure *cc = (GCClosure*) closure;
  gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__UINT64_UINT_UINT_UINT) (marshal_data ? marshal_data : cc->callback);
